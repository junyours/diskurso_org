...
@section('content')
  <div class="text-justify space-y-4">
    ...
    <div class="space-y-2">
      <p>The DisKURSO International Multidisciplinary Research Journal reflects the institution’s commitment of Tagoloan
      ...
      <p>
        ...
        practitioners, and policymakers. By embracing interdisciplinary research, DisKURSO aims to address the complex
      ...
      <p>
        Through its rigorous peer-review process and commitment to academic excellence, the DisKURSO International
        Multidisciplinary Research Journal aims to contribute significantly to the global research community. The journal
    ...
    <div class="space-y-2">
      ...
      <p>
        With its well-established credentials and adherence to national and international standards, DisKURSO stands as a
